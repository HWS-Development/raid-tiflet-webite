...
const Icon = {
  ig: (
    <svg
      viewBox="0 0 24 24"
      className="w-[18px] h-[18px] text-ec"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.8"
      aria-hidden
  ...
  wa: (
    ...
    viewBox="0 0 640 640"
    fill="currentColor"
    className="block w-[18px] h-[18px] text-ec">
...
function SocialBtn({ href, label, children }) {
  return (
    <a
      className="group relative inline-flex h-10 w-10 items-center justify-center rounded-full ring-1 ring-white/20 bg-white/5
            ...
            <div className="mt-3 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <a href={waFR} target="_blank" rel="noreferrer"
                   className="inline-flex items-center gap-1 text-xs px-2 py-1 rounded-full bg-white/10 ring-1 ring-white/15 hover:bg-white/15">
